                ...
                <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100 rounded-md">
                    <form onSubmit={handleRegister} className="card-body">
                        <div className="form-control">
                            ...
                            <input name="name" type="text" placeholder="name" className="input input-bordered border-2 border-slate-600 rounded-sm" required />
                        </div>
                        <div className="form-control">
                            <label className="label">
                        ...
                        <div className="form-control mt-6">
                            <button className="border-2 font-semibold text-slate-600 border-slate-600 hover:border-orange-600 hover:text-orange-600 p-2 w-full">Register</button>
                        </div>
